...
\chapter{Theory}
The underlying theory for understanding THz-TDS, the fundamentals of THz generation and its challenges at low frequencies in pulsed systems are outlined in the following. 
...
\input{chapters/Theory/padResonances.tex}
...
\begin{itemize}
	\item maybe talk about SC props real quick 
\end{itemize}
Two photoconductor wafers that were already grown at the institute were chosen because they showed promising performance in past experiments. The wafers need to be cleaved into appropriate size before various processing steps can be performed. The fabrication process of the H-Dipole antennas that were proposed previously is described. The processed antennas are DC characterized to ensure suitability for usage in THz-TDS experiments. 
...
\input{chapters/Device Fabrication and DC Characterization/DC_char.tex}
